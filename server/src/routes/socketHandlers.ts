...
socket.on('createRoom', mySocketService.createRoom);
socket.on('joinRoom', mySocketService.joinRoom);
socket.on('getUser', mySocketService.getUser);
socket.on('leaveRoom', mySocketService.leaveRoom);
