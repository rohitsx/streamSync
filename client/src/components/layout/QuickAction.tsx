  ...
  return (
    <>
      <section className="bg-gray-800  rounded-lg p-3 shadow-lg border border-gray-700 hover:border-purple-500 transition-colors duration-300">
        ...
        <Link
          to={"host"}
          className="bg-gradient-to-br from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800 text-white font-bold py-3 px-4 rounded-lg flex flex-col transition duration-300 ease-in-out transform hover:-translate-y-1"
        >
